...
{
    public class TransfiyaCreditController : Controller
    {
        // GET: TransfiyaCredit
        ...
        public async Task<ActionResult> Create([DataSourceRequest] DataSourceRequest request, clients_accounts_limit_low_amount_credit_UI model)
        {
            ...
            var result = await ClsContactLess.CreateCredito(model);
        ...
        {
            ClsContactLess ClsContactLess = new ClsContactLess();
            var result = await ClsContactLess.GetCredito();
        ...
        public async Task<ActionResult> Update([DataSourceRequest] DataSourceRequest request, clients_accounts_limit_low_amount_credit_UI model)
        {
            ClsContactLess ClsContactLess = new ClsContactLess();
            string decimales = "00";
            string max_amo = ((model.MAX_VALUE * Convert.ToInt32(model.MAX_OPE)) + 1).ToString();
            ...
            model.MAX_VALUE = Convert.ToInt32(max_value);
            model.MAX_AMO = Convert.ToInt32(max_amo);
            var result = await ClsContactLess.UpdateCredito(model);
        ...
        public async Task<ActionResult> Delete([DataSourceRequest] DataSourceRequest request, clients_accounts_limit_low_amount_credit_UI model)
        {
            ClsContactLess ClsContactLess = new ClsContactLess();
            var result = await ClsContactLess.DeleteCredito(model);
